...
export const enUS: MessageSchema = {
  ...
  ssh: {
    ...
    emptyDescription: "Add a server connection first, then run commands in batch from the bottom bar.",
    nameLabel: "Name",
    hostLabel: "Host",
    portLabel: "Port",
    ...
    broadcastLabel: "Send to all ready connections",
    noActiveOutput: "Select or add a connection to view command output here.",
    saveSuccess: "Connection saved.",
    deleteSuccess: "Connection deleted.",
    connectSuccess: "Connection validated.",
    runSuccess: "Command execution finished.",
    formInvalid: "Fill in all required connection fields.",
    noTargetError: "Select at least one SSH connection that is ready.",
  ...
  tools: {
    ...
    ssh: {
      label: "SSH Batch Runner",
      description: "Run commands across multiple servers",
    },
    redis: {
      label: "Redis Manager",
